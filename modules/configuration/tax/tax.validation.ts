...
export function validateCreateTax(req: Request): string[] {
  const errors: string[] = [];
  const body = req.body;
...
export function validateUpdateTax(req: Request): string[] {
  const errors: string[] = [];
  const body = req.body;
...
export function validateCreateTaxConfig(req: Request): string[] {
  const errors: string[] = [];
  const body = req.body;
...
export function validateUpdateTaxConfig(req: Request): string[] {
  const errors: string[] = [];
  const body = req.body;
