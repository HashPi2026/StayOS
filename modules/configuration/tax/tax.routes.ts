...
import {
  validateCreateTax,
  validateCreateTaxConfig,
  validateUpdateTax,
  validateUpdateTaxConfig,
} from './tax.validation';
...
taxRouter.post(
  '/:taxId/configurations',
  validate(validateCreateTaxConfig),
  taxController.createConfiguration
);
taxRouter.put(
  '/:taxId/configurations/:configId',
  validate(validateUpdateTaxConfig),
  taxController.updateConfiguration
);
