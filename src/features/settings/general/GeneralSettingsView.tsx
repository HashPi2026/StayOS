...
import { GeneralSettingsTab } from '@/src/types';
import { RentalSettingsTab } from './rental/RentalSettingsTab';
import { FeatureSettingsTab } from './feature/FeatureSettingsTab';
import { NightAuditsTab } from './night-audit/NightAuditsTab';
import { LocalizationTab } from './localization/LocalizationTab';
import { DisplayTab } from './display/DisplayTab';
import { FoliosTab } from './folio/FoliosTab';
import { CreditCardsTab } from './credit-card/CreditCardsTab';
import { EmailsTab } from './email/EmailsTab';
import { GuestMandatoryDataTab } from './guest-mandatory-data/GuestMandatoryDataTab';
