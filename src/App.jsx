...
import { RoomTypesListView, AddRoomTypeView, EditRoomTypeView, RoomTypeDrawer, DeleteRoomTypeDialog, } from './features/property/room-type';
import { RoomsListView, AddRoomView, EditRoomView, BulkAddRoomsView, DeleteRoomDialog, } from './features/property/room';
import { RoomStatusMasterView, RoomStatusDrawer, DeleteRoomStatusDialog, } from './features/property/room-status';
import { TaxesView, TaxConfigurationView, AddTaxView, AddTaxRateView, TaxDrawer, TaxRuleDrawer, TaxConfigDrawer, DeleteTaxDialog, } from './features/property/tax';
...
import { OtherChargesView, AddOtherChargeView, OtherChargeDrawer, DeleteOtherChargeDialog, } from './features/configuration/other-charge';
import { MeasurementUnitsView, AddMeasurementUnitView, MeasurementUnitDrawer, DeleteMeasurementUnitDialog, } from './features/configuration/measurement-unit';
import { PaymentTypesView, AddPaymentTypeView, PaymentTypeDrawer, DeletePaymentTypeDialog, } from './features/configuration/payment-type';
import { ExchangeRatesView, AddExchangeRateView, ExchangeRateDrawer, DeleteExchangeRateDialog, } from './features/configuration/exchange-rate';
import { RolesPrivilegesView, RoleDrawer, DeleteRoleDialog, } from './features/configuration/roles-privileges';
import { PoliciesView, AddPolicyView, DeletePolicyDialog, } from './features/configuration/policy';
import { GuestCategoriesView, AddGuestCategoryView, DeleteGuestCategoryDialog, } from './features/configuration/guest-category';
import { EmailTemplatesView, AddEmailTemplateView, EmailTemplateDrawer, DeleteEmailTemplateDialog, } from './features/configuration/email-template';
import { UserManagementView, AddUserView, InviteUserModal, } from './features/configuration/user';
// Settings Features
...
// Miscellaneous Views
import { AmenitiesView, AuditLogsView, SystemHealthView, GenericSettingsView, } from './features/miscellaneous';
const MainLayout = () => {
    ...
    const renderActiveScreen = () => {
        switch (activePath) {
            ...
            case 'integrations':
                return (<GenericSettingsView title="System Integrations" subtitle="Configure PMS sync, OTA channel managers, and payment terminals." category="Settings"/>);
            case 'notifications':
                return (<GenericSettingsView title="Notification Rules" subtitle="Set up automated guest SMS, confirmation emails, and lead alerts." category="Settings"/>);
            case 'audit-logs':
