...
export const GlobalSearchModal: React.FC = () => {
  ...
  const baseOptions: SearchOption[] = [
    ...
    },
    {
      ...
      path: 'taxes',
      description: 'VAT, municipal city accommodation taxes, and service charges.',
    },
    {
      id: 'opt-policies',
  ...
  const allOptions = [...baseOptions, ...buildingOptions];
  ...
  const handleSelect = (option: SearchOption) => {
    navigate(option.path, option.buildingId);
